...
export default function ApproachSection() {
  const [data, setData] = useState({
    approachTitle: 'The DK Advantage',
  ...
  const features = [
    {
      title: data.adv1Title,
      description: data.adv1Desc,
      icon: 'workspace_premium',
      iconBg: 'bg-secondary text-white',
    },
    {
      title: data.adv2Title,
      description: data.adv2Desc,
      icon: 'trending_up',
      iconBg: 'bg-primary text-white',
    },
    {
      title: data.adv3Title,
      description: data.adv3Desc,
      icon: 'groups',
